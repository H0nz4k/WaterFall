...
**Verze:** `0.4.10` · soubor [`VERSION`](VERSION) · historie v [`CHANGELOG.md`](CHANGELOG.md)  
...
Firmware sondy se verzuje zvlášť. WaterFall 0.4.10 očekává Probe **0.7.2** (`WATERFALL_COMPAT=0.4.1`).
